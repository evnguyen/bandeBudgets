...
export default function HomePage() {
	...
	const { incomeCategories, expensesByGroup, hasExpenses, hasCategories } = useMemo(() => {
		...
		return {
			...
			hasExpenses: Array.from(grouped.values()).some(list => list.length > 0),
