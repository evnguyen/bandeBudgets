...
import { BudgetItem, TransactionType } from '@/lib/types';
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-0.5 flex items-baseline gap-1.5">
              <span
                className={cn('text-lg font-bold', isOverBudget && 'text-red-500')}
              >
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  cannot be undone and will remove all associated transactions.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
